...
public class LeadConfiguration : BaseEntityConfiguration<Lead>
{
    public override void Configure(EntityTypeBuilder<Lead> builder)
    {
        ...
        builder.Property(x => x.CompanyName).HasMaxLength(NameConsts.MaxLength).IsRequired(true);
        builder.Property(x => x.CompanyDescription).HasMaxLength(DescriptionConsts.MaxLength).IsRequired(false);
        builder.Property(x => x.CompanyAddressStreet).HasMaxLength(NameConsts.MaxLength).IsRequired(true);
        builder.Property(x => x.CompanyAddressCity).HasMaxLength(NameConsts.MaxLength).IsRequired(true);
        builder.Property(x => x.CompanyAddressState).HasMaxLength(NameConsts.MaxLength).IsRequired(true);
        ...
        builder.Property(x => x.CompanyPhoneNumber).HasMaxLength(NameConsts.MaxLength).IsRequired(true);
        builder.Property(x => x.CompanyFaxNumber).HasMaxLength(NameConsts.MaxLength).IsRequired(false);
        builder.Property(x => x.CompanyEmail).HasMaxLength(EmailConsts.MaxLength).IsRequired(true);
        ...
        builder.Property(x => x.DateProspecting).IsRequired(true);
        builder.Property(x => x.DateClosingEstimation).IsRequired(true);
        builder.Property(x => x.DateClosingActual).IsRequired(false);
        builder.Property(x => x.AmountTargeted).IsRequired(true);
        builder.Property(x => x.AmountClosed).IsRequired(true);
        builder.Property(x => x.BudgetScore).IsRequired(true);
        builder.Property(x => x.AuthorityScore).IsRequired(true);
        builder.Property(x => x.NeedScore).IsRequired(true);
        builder.Property(x => x.TimelineScore).IsRequired(true);
        builder.Property(x => x.PipelineStage).HasConversion<string>().IsRequired(true);
