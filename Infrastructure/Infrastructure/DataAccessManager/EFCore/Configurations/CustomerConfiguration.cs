...
public class CustomerConfiguration : BaseEntityConfiguration<Customer>
{
    public override void Configure(EntityTypeBuilder<Customer> builder)
    {
        ...
        builder.Property(x => x.Street).HasMaxLength(NameConsts.MaxLength).IsRequired(true);
        builder.Property(x => x.City).HasMaxLength(NameConsts.MaxLength).IsRequired(true);
        builder.Property(x => x.State).HasMaxLength(NameConsts.MaxLength).IsRequired(true);
        builder.Property(x => x.ZipCode).HasMaxLength(NameConsts.MaxLength).IsRequired(true);
        builder.Property(x => x.Country).HasMaxLength(NameConsts.MaxLength).IsRequired(true);
        ...
        builder.Property(x => x.CustomerGroupId).HasMaxLength(IdConsts.MaxLength).IsRequired(true);
        builder.Property(x => x.CustomerCategoryId).HasMaxLength(IdConsts.MaxLength).IsRequired(true);
